      ...
      <div className="container relative z-20 mx-auto px-6 lg:px-12 flex justify-between items-center w-full pt-20">
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <a href="https://www.instagram.com/skola_aari_world_?igsh=MTdwNms5cnd1bmJpNw==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center text-white hover:bg-brand-gold hover:border-brand-gold transition-colors duration-300 hover:scale-110 transform">
